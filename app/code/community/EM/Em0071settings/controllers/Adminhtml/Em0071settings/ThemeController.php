<?php
class EM_Em0071settings_Adminhtml_Em0071settings_ThemeController extends Mage_Adminhtml_Controller_Action
{
	protected $_prefixBlock = 'em0071_';
	protected $_prefixPage = 'em0071_';
	protected $_packageTheme = 'default/em0071';
