<?php
class EM_Em0071settings_Adminhtml_Em0071settings_LinkController extends Mage_Adminhtml_Controller_Action
{
	...
	public function userguideAction() {
		$this->getResponse()->setRedirect('http://www.emthemes.com/documentation/em0071-userguide/');
	}
