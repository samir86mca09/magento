<?php
class EM_Em0071settings_Helper_Sample extends Mage_Core_Helper_Abstract
{
	protected $_themeSlug  = 'default/em0071';
	...
	protected $_megaMenuModel = 'em0071settings/megamenupro';
